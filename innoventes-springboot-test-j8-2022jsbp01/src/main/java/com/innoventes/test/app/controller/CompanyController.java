...
public class CompanyController {
	...
	@GetMapping("/{id}")
	public Company getRecordById(@PathVariable Long id) {
	...
	public ResponseEntity<?> getCompanyByCode(@PathVariable String comapnyCode){
		return companyService.findByCompanyCode(companyCode).map(ResponseEntity::ok.orElseGet(()->ResponseEntity.notFound().build()));
	}
